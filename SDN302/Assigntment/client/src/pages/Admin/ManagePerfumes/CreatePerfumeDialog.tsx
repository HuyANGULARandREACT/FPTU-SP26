...
interface CreatePerfumeDialogProps {
  onSubmit: (data: CreatePerfumeFormData) => Promise<void>;
}
...
const CreatePerfumeDialog = ({ onSubmit }: CreatePerfumeDialogProps) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      ...
      try {
        ...
        setSubmitError(
          err instanceof Error ? err.message : "Failed to create Perfume",
        );
      } finally {
        setSubmitting(false);
      }
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={formik.isSubmitting}>
              {formik.isSubmitting ? "Creating..." : "Create Perfume"}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
